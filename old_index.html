...
<head>
    ...
    <title>Magnus Nordbye Web Development</title>

    <link rel="stylesheet" href="style/style.css">

    <script src="https://kit.fontawesome.com/781b3885c7.js" crossorigin="anonymous"></script>
...
<header class="site__header">
    <div class="header__wrapper">
        ...
        <div class="header__title">
            <h1><strong>Magnus Nordbye</strong> Web Development</h1>
        </div>
...
<section class="aboutme">
    ...
    <div class="aboutme__image">
        <img src="images/xxxxxxxxxxxxx" alt="Photo Magnus Nordbye">
    </div>
</section>
